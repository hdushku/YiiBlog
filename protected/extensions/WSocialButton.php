...
class WSocialButton extends CWidget {
    ...
    public function init() {
        ...
        Yii::app()->clientScript->registerScriptFile('http://userapi.com/js/api/openapi.js?47', CClientScript::POS_HEAD);
        Yii::app()->clientScript->registerScript('vkontakte','VK.init({apiId: 2762923, onlyWidgets: true});', CClientScript::POS_HEAD);
    }
