...
class ETinyMce extends CInputWidget
{
   ...
   *
   ...
   protected function makeFullEditor($url='')
   {
      ...
      $options['theme_advanced_buttons1'] = "save,|,{$sc}formatselect,fontselect,fontsizeselect,|,justifyleft,justifycenter,justifyright,justifyfull,|,forecolor,backcolor,|,bold,italic,underline,strikethrough,|,sub,sup,blockquote";
	  $options['theme_advanced_buttons2'] = "cut,copy,paste,pastetext,pasteword,|,search,replace,|,undo,redo,|,removeformat,cleanup,|,bullist,numlist,|,outdent,indent,|,charmap,emotions,media,image,|,link,unlink,anchor,|,visualaid,visualchars,|,code,fullscreen,";
...
EOP;
   ...
   protected function makeCustomEditor($url='')
   {
      ...
      $options['theme_advanced_toolbar_align'] = 'left';
      $options['theme_advanced_path_location'] = 'bottom';
	  $options['theme_advanced_buttons1'] = "{$sc}formatselect,|,bold,italic,underline,strikethrough,|,pastetext,pasteword,|,undo,redo,|,code,fullscreen,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,blockquote,|,media,image,|,link,unlink";
